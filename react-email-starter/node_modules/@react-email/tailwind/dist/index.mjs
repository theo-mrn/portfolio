...
function Jt(s, e) {
  const t = gt.Children.map(s, (r) => {
    if (gt.isValidElement(r)) {
      const n = { ...r.props };
      r.props.children && !As(r) && (n.children = Jt(r.props.children, e));
      const l = e(
        gt.cloneElement(r, n, n.children)
      );
      if (gt.isValidElement(l) && (typeof l.type == "function" || // @ts-expect-error - we know this is a component that may have a render function
      l.type.render)) {
...
const Yc = (s, e) => {
  ...
  return {
    elementWithInlinedStyles: gt.cloneElement(
      s,
      l,
      l.children
    ),
  ...
  if (Hc(r), l) {
    ...
    if (i = Jt(i, (a) => {
      ...
      if (mr.isValidElement(a) && a.type === "head") {
        c = !0;
        const o = /* @__PURE__ */ Ms("style", { children: Cl(r.toString().trim()) });
